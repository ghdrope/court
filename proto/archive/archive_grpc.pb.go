...
const (
	ArchiveService_StoreIncident_FullMethodName = "/archive.v1.ArchiveService/StoreIncident"
)
...
func (c *archiveServiceClient) StoreIncident(ctx context.Context, in *StoreIncidentRequest, opts ...grpc.CallOption) (*StoreIncidentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StoreIncidentResponse)
	err := c.cc.Invoke(ctx, ArchiveService_StoreIncident_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedArchiveServiceServer) StoreIncident(context.Context, *StoreIncidentRequest) (*StoreIncidentResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method StoreIncident not implemented")
}
...
func _ArchiveService_StoreIncident_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StoreIncidentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ArchiveServiceServer).StoreIncident(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ArchiveService_StoreIncident_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArchiveServiceServer).StoreIncident(ctx, req.(*StoreIncidentRequest))
	}
...
var ArchiveService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "archive.v1.ArchiveService",
	HandlerType: (*ArchiveServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "StoreIncident",
			Handler:    _ArchiveService_StoreIncident_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/archive/archive.proto",
}
